...
function Navbar() {
  ...
  // Enhanced logout - clears ALL data including localStorage/sessionStorage/cookies 
  // This prevents back button from accessing protected pages after logout
...
export default function App() {
  ...
  async function logout() {
    ...
    setUser(null)
    // push login route so back button does not return to protected page
